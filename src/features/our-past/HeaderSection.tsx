...
export default function HeaderSection() {
  return (
    <section className="relative flex min-h-[70vh] w-full flex-col items-start justify-center gap-4 overflow-hidden px-4 py-12 text-white sm:min-h-[75vh] sm:gap-6 sm:py-14 md:min-h-[80vh] md:gap-8 md:py-16 lg:min-h-[85vh] lg:gap-10 lg:py-20">
      ...
      <div className="relative z-20 flex w-full max-w-7xl flex-col items-start gap-2 px-4 sm:gap-3 md:gap-4 lg:px-8 lg:text-left xl:px-12">
        ...
        <h1 className="text-secondary-400 -skew-3 text-6xl leading-tight sm:text-7xl md:text-8xl lg:text-9xl xl:text-[9rem] 2xl:text-[10rem]">
          PREVIOUS MEMBER
        </h1>
      </div>
