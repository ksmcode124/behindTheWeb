...
function DivisionCarousel({ divisions }: { divisions: Divisi[] }) {
  const carouselImages = divisions.map((division) => ({
    src: division.foto_divisi ?? '/assets/images/origin_first_commit.webp',
  }));
  ...
  return (
    <>
      ...
      <section className="flex w-full items-center justify-center px-[11vw] py-[11vw] lg:mb-10">
        <div className="relative flex h-full w-full items-center justify-center bg-[url('/assets/images/hero_bg.webp')] bg-cover bg-center p-[4vw] shadow-[0_0_0_4vw_var(--color-primary-200),0_0_0_8vw_var(--color-primary-500),0_0_0_12vw_var(--color-primary-400)]">
