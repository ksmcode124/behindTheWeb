...
export function AccordionParent() {
  ...
  return (
    <div className="flex items-center justify-center gap-4 bg-cover">
      <div ref={cardRefs[0]}>
        <Card
          title="visi"
...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-row items-center justify-center gap-8 bg-black p-8 pb-20 font-sans sm:p-20">
      <button
        onClick={handlePrev}
